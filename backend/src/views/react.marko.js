...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/stock-tracker$1.0.0/views/react.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("</head><body><noscript>You need to enable JavaScript to run this app.</noscript><div id=root></div><script src=/react/static/js/bundle.js></script><script src=/react/static/js/0.chunk.js></script><script src=/static/js/main.chunk.js></script>");
...
marko_template.meta = {
    id: "/stock-tracker$1.0.0/views/react.marko",
    tags: [
